...
const Membership = () => {
  return (
    <section className='grid grid-cols-12 grid-rows-6'>
      <article className='rounded-tr-lg lg:rounded-r-none lg:rounded-bl-lg col-span-12 row-span-3 lg:col-span-6 lg:row-span-6 bg-slate-700 p-4'>
        ...
        <ul className='grid grid-cols-12 grid-rows-6'>
          <li className='col-span-12 row-span-3 lg:col-span-6 lg:row-span-3 flex'>
      ...
      <article className='rounded-bl-lg lg:rounded-l-none lg:rounded-tr-lg col-span-12 row-span-3 lg:col-span-6 lg:row-span-6 bg-slate-600 p-4'>

...
const FeaturesGrid = () => {
  return (
    <ul className='pattern my-12 grid grid-cols-12 gap-8 bg-gray-800 p-8 lg:px-16'>
      <li className='features-card'>
        <figure className='features-icon border-theme shadow-lg'>
          <MdTimer className='text-5xl' />
        </figure>
        <h2 className='col-span-12 row-span-1 flex items-baseline pt-6 text-lg font-bold capitalize tracking-wide'>
          Full workout in 60 minutes
        </h2>
        <div className='features-divider'></div>
        <p className='col-span-12 row-span-2 font-light leading-loose lg:leading-relaxed'>
